...
- [ ] Single-trace DAG with D3 + dagre
- [ ] Data dependency inference algorithm
- [ ] Divergence branch rendering
- [ ] Multi-trace aggregation algorithm
- [ ] Aggregated DAG with frequency heatmap
